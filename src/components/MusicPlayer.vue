...
<main class="audioPlayer mt-4" id="app">
	<a class="nav-icon" v-on:click="isPlaylistActive=!isPlaylistActive" :class="{'isActive': isPlaylistActive}" title="Music List">
		  <span></span>
		  <span></span>
		  <span></span>
		</a>
	<div class="audioPlayerList overflow-auto scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-100" :class="{'isActive': isPlaylistActive}">
		...
		musicPlaylist: [
			{
				...
				url: "https://dlamadziulki.pl/assets/songs/stacja.mp3",
				image: "https://dlamadziulki.pl/assets/covers/stacja.jpg"
			},
			{
				title: "Hugging You",
				artist: "Daniel Simion",
				url: "https://dlamadziulki.pl/assets/songs/huggingyou.mp3",
				image: "https://dlamadziulki.pl/assets/covers/huggingyou.jpg"
			},
			{
				title: "Untill I Found You",
				artist: "Daniel Simion",
				url: "https://dlamadziulki.pl/assets/songs/untill.mp3",
				image: "https://dlamadziulki.pl/assets/covers/untill.jpg"
			},
			{
